...
<div class="tab-content">
    <div class="tab-pane active" id="data1">
        <table class="table table-bordered">
            ...
            <?php while($row = mysqli_fetch_array($unpaid,MYSQLI_ASSOC)){ ?>
                <tr>
    ...
    <div class="tab-pane" id="data2">
        <table class="table table-bordered">
            ...
            <?php while($row = mysqli_fetch_array($delivered,MYSQLI_ASSOC)){ ?>
                <tr>
    ...
    <div class="tab-pane" id="data3">
        <table class="table table-bordered">
            ...
            <?php while($row = mysqli_fetch_array($paid,MYSQLI_ASSOC)){ ?>
                <tr>
                    <td class="text-center"><?php echo $row['dateDelivered']; ?></td>
                    <td><?php echo $row['name']; ?></td>
