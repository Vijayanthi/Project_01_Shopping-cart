<?php
	...
	if(!empty($prodID)){
		...
		$sqlSelectSpecProd = mysqli_query($con ,"select * from products where id = '$prodID'") or die(mysql_error());
		$getProdInfo = mysqli_fetch_array($sqlSelectSpecProd,MYSQLI_ASSOC);
